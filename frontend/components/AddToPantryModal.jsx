            ...
            {scannedIngredients.length === 0 ? (
              ...
              <div className="space-y-4">
                ...
                {selectedImage && !scanning && (
                  <Button
                    onClick={handleScan}
                    className="w-full bg-[var(--green)] hover:bg-[var(--green-dark)] text-white h-12 text-lg"
                    disabled={scanning}
                  >
                    {scanning ? (
                      <>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-[var(--green-muted)]">
                ...
                <div className="space-y-3 max-h-96 overflow-y-auto">
                  {scannedIngredients.map((ingredient, index) => (
                    <div
                      key={index}
                      className="flex items-center gap-3 p-4 bg-[var(--beige-light)] rounded-xl border border-[var(--border)]"
                    >
                      <div className="flex-1">
                        <div className="font-medium text-[var(--green-dark)]">
                          {ingredient.name}
                        </div>
                        <div className="text-sm text-[var(--green-muted)]">
                          {ingredient.quantity}
                        </div>
                      </div>
                      ...
                      <Button
                        ...
                        className="text-[var(--green-muted)] hover:text-red-600"
                      >
                        <X className="w-4 h-4" />
                      </Button>
                    </div>
          ...
          <TabsContent value="manual" className="mt-6">
            <form onSubmit={handleAddManual} className="space-y-4">
              ...
              <Button
                type="submit"
                disabled={adding}
                className="flex-1 bg-[var(--green)] hover:bg-[var(--green-dark)] text-white h-12 w-full"
              >
                {adding ? (
                  <>
                    <Loader2 className="w-5 h-5 mr-2 animate-spin" />
